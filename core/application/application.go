...
var Application = func(info ApplicationInfo, userId int) ([]byte, error) {
...
func TempApplication(info ApplicationInfo, userId int) (types.UdpRequest, error) {
